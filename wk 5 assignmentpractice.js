...
start() { //start or entry point of menu application
    ...
    while (selection != 0) { //variabe to get user imput of what option in the menu the user selected
...
viewIceCream() { 
    ...
    let selection = this.showIceCreamMenuOptions(description); //displays options for the brand
